...
public class cosmeticProductAdapter extends RecyclerView.Adapter<cosmeticProductAdapter.MyViewHolder>
{
    ...
    //constructor calling
    public cosmeticProductAdapter(Context context, ArrayList<ProductList> list) {
