...
public class ChangeProductImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_product_image);
        ...
        storageReference.putFile(imageuri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        iv.setImageURI(null);
                        Toast.makeText(ChangeProductImage.this, "successfully uploaded", Toast.LENGTH_SHORT).show();
                        if(pd.isShowing()){
                            pd.dismiss();
                        }
                        //set profile image
                        ...
                        Intent intent = new Intent(ChangeProductImage.this,addProductActivity.class);
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ChangeProductImage.this, "upload Failed", Toast.LENGTH_SHORT).show();
                        if(pd.isShowing()){
                            pd.dismiss();
                        }
                    }
